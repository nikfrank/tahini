...
describe('simpleHTTP', ()=>{
  ...
  it.skip('fetch handler calls errAction', (done)=>{
  ...
  it.skip('resolves network handlers, then directs requests to them, dispatch nextAction', (done)=>{
  ...
  it.skip('dispatches next and done', (done)=>{
    // initiate the middleware with handler
    // mock dispatching an action with a .network, test the same things
  ...
  it.skip('dispatches err and done', (done)=>{
    const testValue = 'blah';    
    global.fetch = sinon.stub().returns( Promise.resolve({
      status:400,
      json: ()=>Promise.resolve({data:testValue})
  ...
  it.skip('reuses the activeHandler namespace', ()=>{
  ...
  it.skip('reuses the handler which already exists', ()=>{
    const activeHandlers = {};
  ...
  it.skip('calls preflight actions', ()=>{
    const activeHandlers = {};
  ...
  it.skip('passes over actions without .network', ()=>{
    const activeHandlers = {};
  ...
  it.skip('integrates withe framework injector, errs on non-existant handler', ()=>{
    const activeHandlers = {};
